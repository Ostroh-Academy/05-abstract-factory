...
{
    public class ConvexPolygon : IFigure
    {
        ...
        public bool CreatePolygon()
        {
            if (IsConvex(_points))
            {
                Console.WriteLine("Створено опуклий полігон");
                return true;
            }
            else
            {
                Console.WriteLine("Не вдається створити опуклий многокутник: вхідні точки не утворюють опуклий многокутник");
                return false;
            }
        }
